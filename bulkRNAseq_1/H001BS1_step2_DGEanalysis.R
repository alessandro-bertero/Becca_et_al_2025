...
if(analysis == TRUE){
  ...
  #folders creation
  dir.create(paste0("/home/shared_folder/RData"))
  
  dir.create(paste0("/home/shared_folder/Tables"))
  dir.create(paste0("/home/shared_folder/Tables/DGEs"))
  dir.create(paste0("/home/shared_folder/Tables/GSEA"))
  dir.create(paste0("/home/shared_folder/Tables/PCA"))
  dir.create(paste0("/home/shared_folder/Tables/Counts"))
  
  dir.create(paste0("/home/shared_folder/Plots"))
  dir.create(paste0("/home/shared_folder/Plots/QC"))
  dir.create(paste0("/home/shared_folder/Plots/QC/QC"))
  dir.create(paste0("/home/shared_folder/Plots/QC/Biotypes"))
  dir.create(paste0("/home/shared_folder/Plots/QC/Correlation"))
  dir.create(paste0("/home/shared_folder/Plots/QC/PCA"))
  dir.create(paste0("/home/shared_folder/Plots/QC/Variability"))
  dir.create(paste0("/home/shared_folder/Plots/QC/Chromosomes"))
  dir.create(paste0("/home/shared_folder/Plots/Analysis"))
  dir.create(paste0("/home/shared_folder/Plots/Analysis/Boxplots"))
  dir.create(paste0("/home/shared_folder/Plots/Analysis/Heatmaps"))
  dir.create(paste0("/home/shared_folder/Plots/Analysis/Modules"))
  dir.create(paste0("/home/shared_folder/Plots/Analysis/Modules/GO"))
  dir.create(paste0("/home/shared_folder/Plots/Analysis/Modules/Heatmaps"))
  dir.create(paste0("/home/shared_folder/Plots/Analysis/Volcano_plots"))
  dir.create(paste0("/home/shared_folder/Plots/GSEA"))
  dir.create(paste0("/home/shared_folder/Plots/GSEA/dotplots"))
  dir.create(paste0("/home/shared_folder/Plots/GSEA/enrichment_plots"))
  dir.create(paste0("/home/shared_folder/Plots/GSEA/pathways"))
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/QC/counts_distribution.pdf"),
         width = 14, height = 8)
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/Biotypes/mitochondrial_percentages.pdf"),
         width = 14, height = 8)
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/Biotypes/biotypes_percentages.pdf"),
         width = 14, height = 8)
  
  ggplot(biotypes %>% dplyr::filter(biotype != "protein_coding"), aes(x = sample_ID, y = percentage, group = biotype, color = biotype)) +
    geom_line() + geom_point()
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/Biotypes/biotypes_percentages_noproteincoding.pdf"),
         width = 14, height = 8)
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/QC/library_complexity.pdf"),
         width = 14, height = 8)
  
  #gene detection
  plot_gene_detection(dds)
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/QC/gene_detection.pdf"),
         width = 14, height = 8)
  ...
  write.csv(counts_f, file = paste0("/home/shared_folder/Tables/Counts/rawcounts_filtered.csv"))
  
  #Variance stabilization
  vsd = vst(dds)
  mean_sd_plot(vsd)
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/QC/variance_stabilization.pdf"),
         width = 14, height = 8)
  
  #Chromosomal expression
  for(i in chromosomes) {as.ggplot(plot_chromosome(vsd, as.character(i))); ggsave(filename = paste0("/home/shared_folder/Plots/QC/Chromosomes/chr", as.character(i), ".pdf"),
                                                                                  width = 14, height = 7)}
  
  #Replicate variability
  plot_ma = plot_sample_MAs(vsd, group = "condition")
  for(i in 1:length(plot_ma)) {as.ggplot(plot_ma[[i]]); ggsave(filename = paste0("/home/shared_folder/Plots/QC/Variability/", plot_ma[[i]][["labels"]][["title"]], ".pdf"),
                                                               width = 14, height = 7)}
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/Correlation/clustering_beforecorrection.pdf"),
         width = 14, height = 8)
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/Correlation/clustering_aftercorrection.pdf"),
         width = 14, height = 8)
  
  #PCA
  #pca before batch correction
  plot_pca_scatters(vsd, n_PCs = PCA,  color_by = "condition", shape_by = "replicate")
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/PCA/PCA_1to", as.character(PCA), "_beforecorrection.pdf"),
         width = 14, height = 8)
  pca_res1 = plot_pca(vsd, show_plot = FALSE, n_feats = 1000)
  for(i in 1:PCA) {plot_loadings(pca_res1, PC = i, annotate_top_n = 10); ggsave(filename = paste0("/home/shared_folder/Plots/QC/PCA/pca_top10_", as.character(i), "_beforecorrection.pdf"), width = 14, height = 8)}
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/PCA/scree_plot_beforecorrection.pdf"),
         width = 14, height = 8)
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/PCA/PCA_1_2_beforecorrection.pdf"),
         width = 14, height = 8)
  
  loadings1 = as.data.frame(pca_res1[["loadings"]])
  write.csv(loadings1, file = paste0("/home/shared_folder/Tables/PCA/loadings_beforecorrection.csv"))
  
  #pca after batch correction
  plot_pca_scatters(vsd2, n_PCs = PCA,  color_by = "condition", shape_by = "replicate")
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/PCA/PCA_1to", as.character(PCA), "_aftercorrection.pdf"),
         width = 14, height = 8)
  pca_res2 = plot_pca(vsd2, show_plot = FALSE, n_feats = 1000)
  for(i in 1:PCA) {plot_loadings(pca_res2, PC = i, annotate_top_n = 10); ggsave(filename = paste0("/home/shared_folder/Plots/QC/PCA/pca_top10_", as.character(i), "_aftercorrection.pdf"), width = 14, height = 8)}
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/PCA/scree_plot_aftercorrection.pdf"),
         width = 14, height = 8)
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/QC/PCA/PCA_1_2_aftercorrection.pdf"),
         width = 14, height = 8)
  
  loadings2 = as.data.frame(pca_res2[["loadings"]])
  write.csv(loadings2, file = paste0("/home/shared_folder/Tables/PCA/loadings_aftercorrection.csv"))
  ...
  if(length(boxplots) != 0) {
    ...
    ggsave(filename = paste0(paste0("/home/shared_folder/Plots/Analysis/Boxplots/boxplot_", i, ".pdf")), width = 14, height = 8)}}
  }
  ...
  ggsave(filename = paste0(paste0("/home/shared_folder/Plots/Analysis/Heatmaps/heatmap_all_genes.pdf")),
         width = 14, height = 8)
  ...
  if(length(heatmaps) > 2){
    ...
    ggsave(filename = paste0(paste0("/home/shared_folder/Plots/Analysis/Heatmaps/heatmap_selected_genes.pdf")),
           width = 14, height = 8)
  }
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Modules/scale_indipendence.pdf"),
         width = 14, height = 8)
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Modules/heatmap_modules.pdf"),
         width = 14, height = 8)
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Modules/violin_modules.pdf"),
         width = 14, height = 8)
  ...
  ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Modules/boxplots_modules_mean.pdf"),
         width = 14, height = 8)
  ...
  ggplot(mean) +
    ...
    geom_hline(aes(yintercept = 0), linetype = "dashed")
  ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Modules/boxplots_modules_mean-sd.pdf"),
         width = 14, height = 8)
  ...
  for(i in colors){
    ...
    ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Modules/Heatmaps/heatmap_", as.character(i), ".pdf"), width = 14, height = 8);
    ...
    ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Modules/GO/GO_", as.character(ontology), "_", as.character(i), ".pdf"), width = 14, height = 14)
  }
  ...
  write.csv(counts_modules, file = paste0("/home/shared_folder/Tables/Counts/TPMnormalized_counts_modules.csv"))
  write.csv(MEs0, file = paste0("/home/shared_folder/Tables/Counts/eigenvector_modules.csv"))
  ...
  for(i in colnames(table)){x =  grepl("cfr_", i); if(x == TRUE) {
    ...
    if(length(unique(diff$col_to_plot)) == 3){
      ...
      ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Volcano_plots/", cfr_name, ".pdf"), width = 14, height = 8)}
    ...
    if(length(unique(diff$col_to_plot)) == 2){if(sort(unique(diff$col_to_plot))[1] == "other"){
      ...
      ggrepel::geom_text_repel(aes(label = genes_to_plot), max.overlaps = 50,	size = 2, hjust = 1.2) + ggtitle(cfr_name);
      ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Volcano_plots/", cfr_name, ".pdf"), width = 14, height = 8)}}
    write.csv(diff, file = paste0("/home/shared_folder/Tables/DGEs/", cfr_name, ".csv"));
    ...
    ggsave(filename = paste0("/home/shared_folder/Plots/Analysis/Heatmaps/", cfr_name, ".pdf"), width = 14, height = 8);
    genes = diff$logFC;
    ...
    gse = gseGO(geneList = genes, 
                ...
                by = "fgsea");
    res_gsea = gse@result;
    write.csv(res_gsea, file = paste0("/home/shared_folder/Tables/GSEA/", cfr_name, ".csv"));
    dotplot(gse, showCategory = GO_n, split = ".sign") + facet_grid(.~.sign);
    ggsave(filename = paste0("/home/shared_folder/Plots/GSEA/dotplots/", ontology, "_", cfr_name, ".pdf"), width = 14, height = 14);
    ...
    for(j in GSEA){if(j %in% res_gsea$ID){
      ...
      ggsave(filename = paste0("/home/shared_folder/Plots/GSEA/enrichment_plots/runningScore_", cfr_name, "_", gse$Description[n], ".pdf"), width = 14, height = 8);
      ...
      if(length(rownames(counts_gsea)) >= 2){as.ggplot(pheatmap(as.matrix(counts_gsea), scale = "row", cluster_rows = TRUE, show_rownames = TRUE, annotation_col = ann_col, annotation_legend = TRUE, annotation_names_col = TRUE, annotation_colors = ann_colors, color = viridis::viridis(n = 25, option = "H"))) + ggtitle(paste0("Enrichment core genes ", j, " ", cfr_name));
        ggsave(filename = paste0("/home/shared_folder/Plots/GSEA/enrichment_plots/core_", cfr_name, "_", gse$Description[n], ".pdf"), width = 14, height = 8)
      }}};
    ...
    if(length(rownames(diff_k)) != 0){
      ...
      if(length(names(kegg)) > 2){
        kk = gseKEGG(geneList = kegg,
                     ...
                     keyType = "kegg");
        resk = kk@result;
        write.csv(resk, file = paste0("/home/shared_folder/Tables/GSEA/Kegg_", cfr_name, ".csv"));
        for(j in pathways){if(j %in% resk$ID){
          pathview(gene.data = kegg, pathway.id = j, species = kegg_organism, low = list(gene = "#3283FE", cpd = "#3283FE"), mid = list(gene = "gray", cpd = "gray"), high = list(gene =  "#FA0087", cpd =  "#FA0087"), na.col = "transparent", kegg.dir = paste0("/home/shared_folder/Plots/GSEA/pathways/"));
          system2("mv", paste0(j, ".pathview.png /home/shared_folder/Plots/GSEA/pathways/", cfr_name, "_", j, ".png"))
        }}} else{kk = 0; resk = 0}} else{kk = 0; resk = 0}
    save(diff, counts, gse, res_gsea, kk, resk, file = paste0("/home/shared_folder/RData/data_", cfr_name, ".RData"))
  }}
  ...
  save.image(paste0("/home/shared_folder/RData/environment.RData"))
